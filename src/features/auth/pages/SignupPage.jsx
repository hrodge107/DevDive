    ...
    <div className="min-h-screen bg-[#0B1326] text-white font-inter flex flex-col selection:bg-[#22D3EE]/30">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4 relative">
        ...
        <div className="w-full max-w-md bg-[#131A2B] rounded-2xl border border-white/10 p-8 relative z-10 shadow-2xl">
          ...
          <p className="text-slate-400 text-center mb-8">Start your web development journey</p>
          ...
          {successMsg && (
            <div className="bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 p-3 rounded mb-6 text-sm">
              {successMsg}
            </div>
          )}
          ...
          <div className="mt-6 text-center text-sm text-slate-400">
            Already have an account? <Link to="/login" className="text-[#22D3EE] hover:underline">Sign in</Link>
          </div>
        </div>
      </main>
      <Footer />
